 ...
 * @const
 */
proto.Operation.repeatedFields_ = [3];
...
proto.Operation.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    applicationSignature: msg.getApplicationSignature_asB64()
  };
...
proto.Operation.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      msg.setApplicationSignature(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.Operation.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getApplicationSignature_asU8();
  if (f.length > 0) {
    writer.writeBytes(
      4,
      f
 ...
 * @return {number}
 */
proto.Operation.prototype.getOperationId = function() {
 ...
 */
proto.Operation.prototype.setOperationId = function(value) {
 ...
 * @return {number}
 */
proto.Operation.prototype.getApplicationId = function() {
 ...
 * @return {!proto.Operation} returns this
 */
proto.Operation.prototype.setApplicationId = function(value) {
...
proto.Operation.prototype.getCommandsList = function() {
  return /** @type{!Array<!proto.Command>} */ (
    jspb.Message.getRepeatedWrapperField(this, command_pb.Command, 3));
};
...
/**
 * optional bytes application_signature = 4;
 * @return {!(string|Uint8Array)}
 */
proto.Operation.prototype.getApplicationSignature = function() {
...
/**
 * optional bytes application_signature = 4;
 * This is a type-conversion wrapper around `getApplicationSignature()`
 * @return {string}
 */
proto.Operation.prototype.getApplicationSignature_asB64 = function() {
 ...
 * @return {!Uint8Array}
 */
proto.Operation.prototype.getApplicationSignature_asU8 = function() {
 ...
 * @return {!proto.Operation} returns this
 */
proto.Operation.prototype.setApplicationSignature = function(value) {
